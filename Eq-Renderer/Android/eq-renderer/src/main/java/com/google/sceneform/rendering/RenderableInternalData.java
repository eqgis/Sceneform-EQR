...
class RenderableInternalData implements IRenderableInternalData {
     ...
     */
    @Override
    public void changePrimitiveType(RenderableInstance instance, RenderableManager.PrimitiveType primitiveType) {
        ...
        @EntityInstance int renderableInstance = renderableManager.getInstance(instance.getEntity());
