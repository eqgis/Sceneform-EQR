...
public class Material {
    ...
    //<editor-fold> - Not only copy parameters. Modified by Ikkyu 2022/11/15
    @Override
    public Material clone(){
        Material material = new Material(this.materialData,true);
        material.copyMaterialParameters(this.materialParameters);
//        if (i)
        return material;
    }

    Material(MaterialInternalData materialData,boolean isSetMatInstance) {
        this.materialData = materialData;
        materialData.retain();
        if (materialData instanceof MaterialInternalDataImpl) {
            // Do the legacy thing.
            ...
            internalMaterialInstance = internalGltfMaterialInstance;
        }
