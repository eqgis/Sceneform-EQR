...
/**
 * 3DGS文件加载器
 * @author tanyx 2026年1月7日21:38:48
 * @version 1.0
 **/
public class PlyGS3dLoader {
    private long mPlyLoaderNativeObject;
    private Box boundingBox;

    public PlyGS3dLoader() {
    }

    public JPlyGS3dAsset createAssets(byte[] buffer){
        JPlyGS3dAsset jPlyAsset = new JPlyGS3dAsset();
    ...
    public static native void nFill(long mPlyLoaderNativeObject,JPlyGS3dAsset jPlyAsset);
